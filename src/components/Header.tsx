      ...
      <nav className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <Link href="/" passHref>
          <div className="flex items-center space-x-2 cursor-pointer">
            <img src="/images/EL.png" alt="Logo" className="w-8 h-8 rounded-full object-cover filter brightness-0 invert-0 sepia saturate-100 hue-rotate-200" />
        ...
        {/* Nav Links */}
        <div className={`flex-col md:flex md:flex-row md:space-x-6 space-y-4 md:space-y-0 
          absolute md:static top-20 left-0 w-full md:w-auto bg-white p-5 md:p-0 
          ${menuOpen ? 'flex' : 'hidden'} shadow-md md:shadow-none z-40`}
        >
          <Link href="#about" className="hover:text-blue-500 block">About</Link>
          <Link href="#projects" className="hover:text-blue-500 block">Projects</Link>
          <Link href="#contact" className="hover:text-blue-500 block">Contact</Link>
               <a
